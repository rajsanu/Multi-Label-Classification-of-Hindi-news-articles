...
# This module is being used to extract top 100 feature tokens for each label using tf-idf values of tokens
...
# print instances for each label in training dataset
"""
label_cols = cols[3:]
...
store_features(tf_idf, cols, "features.xlsx")
